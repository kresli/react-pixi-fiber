(function (global, factory) {
  ...
  */
  ...
  function usePixiAppCreator(props) {
    ...
    var canvasProps = getCanvasProps(props); // Do not render anything if view is passed to options

    var canvas = options && options.view ? null : React__default.createElement("canvas", _extends({
      ref: canvasRef
    }, canvasProps)); // Initialize pixi application on mount

    React.useLayoutEffect(function () {
      var unmount = createUnmount(ReactPixiFiberAsSecondaryRenderer);
      var view = canvasRef.current;
      var appInstance = createPixiApplication(_objectSpread({
        height: height,
        width: width,
        view: view
      }, options));
      setApp(appInstance); // Destroy pixi application on unmount
